"""
Django settings for odar_42716 project.
...
WSGI_APPLICATION = 'odar_42716.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odar_42716 API",
    "DESCRIPTION": "API documentation for odar_42716 App",
    "VERSION": "v1",
}
